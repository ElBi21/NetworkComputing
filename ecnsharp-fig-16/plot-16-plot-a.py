...
PLT_FILE = "Queue_Track_RED_test_Queue.plt"
...
ax.set_title(r'(a) DCTCP-RED-Tail', fontsize=11, fontweight='bold')
...
plt.tight_layout()
plt.savefig('plot_a_red_queue.png', dpi=150, bbox_inches='tight')
print("Saved: plot_a_red_queue.png")
